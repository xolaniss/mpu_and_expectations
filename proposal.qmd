...
2. **Empirical model:** regress each sector-horizon dispersion measure on lagged domestic and US MPU, exchange-rate volatility, and relevant macro controls (e.g. inflation, policy rate, output gap), using HAC-robust standard errors to address serial correlation typical of overlapping quarterly survey data. We estimate a proxy Baysian SVAR - with SA MPU, US MPU and USDZAR volatility as external instruments
